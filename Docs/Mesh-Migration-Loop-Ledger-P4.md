...
**Started:** 2026-09-02 · **Iteration:** 1 done · **Tree at seed:** main = `262f3da` (pushed; = `3722511` + the launcher commit)
...
## Next item
2 — the single merge path on `mergeMembershipLedger` (2–3 iterations; iteration 2 starts it). Items 5 and 8 are also unblocked (prereq 1 only) if a merge iteration needs to wait.
