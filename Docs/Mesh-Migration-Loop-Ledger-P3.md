...
**Started:** 2026-09-01 · **Iteration:** 5 · **Tree at seed:** main = `801e34f` (pushed); launcher at `adfa3c0`
...
## Next item
5 (membership-driven rotation; also closes item 3's leave-sends-nothing regression by emitting the signed departure). Item 0 stays deferred behind tier-1 work.
