...
| `Fernlet/Tests/FernletTests/ColumnCryptoDeviceBindingTests.swift` | Pins the device-bound sealed-column v2 format: round trip, legacy-blob compatibility (incl. the version-byte nonce collision), cross-install refusal, re-seal rebinding, and fail-open sealing. |
