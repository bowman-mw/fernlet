...
| `Fernlet/FernletKit/Sources/FernletLock/SecureEnclaveContentKeyWrap.swift` | Additive ECIES second wrap of the lock content key under a non-exportable Secure Enclave P-256 key; round-trip-verified, best-effort, with the scrypt-wrapped item kept authoritative (hard binding is an owner decision — Docs/Verifiability.md §6). |
