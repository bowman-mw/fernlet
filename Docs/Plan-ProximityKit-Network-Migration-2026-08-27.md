...
11. **Item 6 — the ungated drain cells.** `MeshRoutedDrainTests` (43 `@Test`) plus ~243 P6-relevant
    cells across fourteen suites are still on no CI line (P6 §12.3 finding 14, unchanged). Gating needs
    a measured step time.
