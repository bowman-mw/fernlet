...
5. **Two smaller replay/digest residuals, both named, neither closed.** (i) D-12.15: a custody
   ...
   **Cost:** staleness, never a lost delivery; a cross-device un-record would be a wire change.
   ...
   budget-bounded and refused at the peer as duplicates, never a stalled or lost delivery** — and an
   item minted since is still offered on the peer's next digest. The text below is what the residual
   said before it was taken.
