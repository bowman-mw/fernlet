...
struct SharedRecipeImportQueueMirrorTests {
    /// The repo root, resolved from this file's compile-time path (matching `S3BoundaryTests`).
    ...
    private static let extensionSourcePath = "FernletShareExtension/SharedRecipeImportQueueWriter.swift"
