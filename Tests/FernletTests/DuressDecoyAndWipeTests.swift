...
struct DuressDecoyVisibilityTests {
    ...
    private func makeStore(_ name: String) -> FernletStore {
        ...
        return FernletStore(repository: LocalFernletRepository(fileURL: url), sensitiveVisibilityDefaults: uniqueSensitiveVisibilityDefaults(), photoDocumentsDirectory: uniquePhotoDirectory())
    }
