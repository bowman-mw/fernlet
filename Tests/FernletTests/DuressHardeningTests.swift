...
struct DuressForensicSourceTests {
    ...
    @Test func theRecoveryCeremonyEmitsNoDuressNamedAuditEvents() throws {
        let source = try Self.source("App/Fernlet/DuressRecoveryCoordinator.swift")
        let logged = source
    ...
    @Test func theCeremonySheetsEmitNoDuressNamedAuditEvents() throws {
        for path in ["App/Fernlet/DuressRecoveryCeremonyViews.swift", "App/Fernlet/DuressPINSetupView.swift"] {
