...
struct HeartDropAppWiringTests {
    ...
    @Test func bothConsentSurfacesSayTheDropOffIsSeparateFromICloudSync() throws {
        ...
        for path in ["App/Fernlet/FriendListView.swift", "App/Fernlet/SettingsSheet.swift"] {
    ...
    @Test func settingsSaysWhatTurningAwayDeliveryOffDoes() throws {
        let source = try String(
            contentsOf: RepoRoot.url.appendingPathComponent("App/Fernlet/SettingsSheet.swift"),
            encoding: .utf8
        )
