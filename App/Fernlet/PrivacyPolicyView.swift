...
struct PrivacyPolicyView: View {
    ...
    private static let effectiveDate = "August 20, 2026"
    ...
    With your permission, Fernlet reads heart rate, active energy, sleep analysis, step count, and workouts to reflect your day. Fernlet writes to Apple Health only what you log yourself, and only in the categories you have separately granted — Apple asks per category, and declining any one of them simply turns that write off: the **workouts** you log, so they count toward your Apple activity rings; your **cycle data** if you use cycle tracking (menstrual flow, basal body temperature, cervical mucus quality, ovulation test results, and spotting — the clinical samples, so your own Health app shows a complete Cycle Tracking picture, while the notes you write about your cycle stay sealed and encrypted on your device); **sexual activity** if you use intimate logging (the event and, if you record it, whether protection was used — your notes stay sealed); **mindful minutes** when you finish a breathing session; and **height and body mass** from the body profile you enter, when you turn on Health syncing for it. Fernlet never writes your journal text, your mood, your hydration, or your hygiene log to Apple Health. Health data is used only on your device and is never sold or used for advertising. Deleting Fernlet does not delete samples it wrote to Apple Health — remove those in the Health app if you wish.
